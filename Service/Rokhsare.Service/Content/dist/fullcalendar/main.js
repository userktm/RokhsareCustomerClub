...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var EventApi = /** @class */ (function () {
        ...
        */
        ...
        Object.defineProperty(EventApi.prototype, "status", {
            get: function () { return this._def.status; },
            enumerable: false,
            configurable: true
        });
    ...
    */
    ...
    function renderInnerContent$2(innerProps) {
        ...
        var status = innerProps.event.status;

        var fc_daygrid_event_dot = "fc-daygrid-event-dot ";
        var fc_event_time = "fc-event-time ";
        var fc_event_title = "fc-event-title ";

        if (status == "force") {
            fc_daygrid_event_dot += "fc-daygrid-event-dot-force";
            fc_event_time += "fc-event-time-force";
            fc_event_title += "fc-event-title-force";
        } else if (status == "notstarted") {
            fc_daygrid_event_dot += "fc-daygrid-event-dot-notstarted";
            fc_event_time += "fc-event-time-notstarted";
            fc_event_title += "fc-event-title-notstarted";
        } else if (status == "finisheduser") {
            fc_daygrid_event_dot += "fc-daygrid-event-dot-finisheduser";
            fc_event_time += "fc-event-time-finisheduser";
            fc_event_title += "fc-event-title-finisheduser";
        } else if (status == "finishedmanager") {
            fc_daygrid_event_dot += "fc-daygrid-event-dot-finishedmanager";
            fc_event_time += "fc-event-time-finishedmanager";
            fc_event_title += "fc-event-title-finishedmanager";
        } else if (status == "reality") {
            fc_daygrid_event_dot += "fc-daygrid-event-dot-reality";
            fc_event_time += "fc-event-time-reality";
            fc_event_title += "fc-event-title-reality";
        }

        return (createElement("div", { id: 'tropin-' + innerProps.event.groupId, className: 'tropin' },
            createElement(Fragment, null,
    createElement("div", { className: fc_daygrid_event_dot, style: { borderColor: innerProps.borderColor || innerProps.backgroundColor } }),
    innerProps.timeText && (createElement("div", { className: fc_event_time }, innerProps.timeText)),
    createElement("div", { className: fc_event_title }, innerProps.event.title || createElement(Fragment, null, "\u00A0")))));
    }
    ...
    var ListViewEventRow = /** @class */ (function (_super) {
        ...
        ListViewEventRow.prototype.render = function () {
            ...
            return (createElement(EventRoot, { seg: seg, timeText: "" // BAD. because of all-day content
                ...
                createElement("td", {
                    ref: innerElRef, headers: eventHeaderId + " " + dateHeaderId, className: "fc-list-event-title"
                }, createElement("a", { href:"", className: "", style: { borderColor: hookProps.borderColor || hookProps.backgroundColor }, }, seg.eventRange.def.title))));
                }));
        };
